...
//  Clase que mantendrá los vuelos en un ArrayList con el proposito de generar vuelos al azar
    ...
    private final int HORAS_MARGEN = 2;
    private final int MINUTOS_MARGEN = 0;
    ...
    public Pasaje crearPasajeRandom() throws Exception{
        ...
        if(vuelos.isEmpty()){
            ...
            Horario horarioInicial = new Horario(horarioActual.getDia(), horarioActual.getHora()
                    + HORAS_MARGEN, horarioActual.getMinutos() + MINUTOS_MARGEN);
            int indiceInicial = -1;
